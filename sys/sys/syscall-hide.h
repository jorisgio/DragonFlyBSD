...
HIDE_BSD(eaccess)
HIDE_BSD(lpathconf)
HIDE_BSD(cap_getmode)
HIDE_BSD(cap_enter)
HIDE_BSD(cap_rights_get)
HIDE_BSD(cap_rights_limit)
HIDE_BSD(cap_ioctls_limit)
HIDE_BSD(cap_ioctls_get)
HIDE_BSD(cap_fcntls_limit)
HIDE_BSD(cap_fcntls_get)
HIDE_BSD(connectat)
HIDE_BSD(bindat)
